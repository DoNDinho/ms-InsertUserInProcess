...
_Microservicio que realiza una inserción previa de un usuario encriptado antes de completar el registro_
...
-   `URIDB`: Ruta base de datos Mongo
...
_Para ejecutar la aplicación importe la colección y entorno en postman ubicado en la carpeta [test](https://github.com/DoNDinho/ms-InsertUserInProcess/tree/main/test)_
